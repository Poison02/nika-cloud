package com.zch.auth.modular.third.service.impl;
...
import com.zch.auth.modular.login.enums.AuthDeviceTypeEnum;
import com.zch.auth.modular.login.service.AuthService;
import com.zch.auth.modular.third.entity.AuthThirdUser;
import com.zch.auth.modular.third.enums.AuthThirdPlatformEnum;
import com.zch.auth.modular.third.mapper.AuthThirdMapper;
...
public class AuthThirdServiceImpl extends ServiceImpl<AuthThirdMapper, AuthThirdUser> implements AuthThirdService {
    ...
    private static final String NIKA_THIRD_GITEE_CLIENT_ID_KEY = "NIKA_THIRD_GITEE_CLIENT_ID";
    private static final String NIKA_THIRD_GITEE_CLIENT_SECRET_KEY = "NIKA_THIRD_GITEE_CLIENT_SECRET";
    private static final String NIKA_THIRD_GITEE_REDIRECT_URL_KEY = "NIKA_THIRD_GITEE_REDIRECT_URL";

    private static final String NIKA_THIRD_WECHAT_CLIENT_ID_KEY = "NIKA_THIRD_WECHAT_CLIENT_ID";
    private static final String NIKA_THIRD_WECHAT_CLIENT_SECRET_KEY = "NIKA_THIRD_WECHAT_CLIENT_SECRET";
    private static final String NIKA_THIRD_WECHAT_REDIRECT_URL_KEY = "NIKA_THIRD_WECHAT_REDIRECT_URL";
    ...
    private AuthRequest getAuthRequest(String source) {
        ...
        if (source.equals(AuthThirdPlatformEnum.GITEE.getValue())) {
            ...
            authRequest = new AuthGiteeRequest(AuthConfig.builder()
                    .clientId(devConfigApi.getValueByKey(NIKA_THIRD_GITEE_CLIENT_ID_KEY))
                    .clientSecret(devConfigApi.getValueByKey(NIKA_THIRD_GITEE_CLIENT_SECRET_KEY))
                    .redirectUri(devConfigApi.getValueByKey(NIKA_THIRD_GITEE_REDIRECT_URL_KEY))
                    .build());
        }
        if(source.equals(AuthThirdPlatformEnum.WECHAT.getValue())){
            // 微信登录
            authRequest = new AuthWeChatOpenRequest(AuthConfig.builder()
                    .clientId(devConfigApi.getValueByKey(NIKA_THIRD_WECHAT_CLIENT_ID_KEY))
                    .clientSecret(devConfigApi.getValueByKey(NIKA_THIRD_WECHAT_CLIENT_SECRET_KEY))
                    .redirectUri(devConfigApi.getValueByKey(NIKA_THIRD_WECHAT_REDIRECT_URL_KEY))
                    .build());
        }
        return authRequest;
    }
