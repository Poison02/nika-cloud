...
public class DevSmsAliyunUtil {
    ...
    private static final String NIKA_SMS_ALIYUN_ACCESS_KEY_ID_KEY = "NIKA_SMS_ALIYUN_ACCESS_KEY_ID";
    private static final String NIKA_SMS_ALIYUN_ACCESS_KEY_SECRET_KEY = "NIKA_SMS_ALIYUN_ACCESS_KEY_SECRET";
    private static final String NIKA_SMS_ALIYUN_END_POINT_KEY = "NIKA_SMS_ALIYUN_END_POINT";
    private static final String NIKA_SMS_ALIYUN_DEFAULT_SIGN_NAME_KEY = "NIKA_SMS_ALIYUN_DEFAULT_SIGN_NAME";
    ...
    private static void initClient() {
        ...
        /* accessKeyId */
        String accessKeyId = devConfigApi.getValueByKey(NIKA_SMS_ALIYUN_ACCESS_KEY_ID_KEY);
        ...
        /* accessKeySecret */
        String accessKeySecret = devConfigApi.getValueByKey(NIKA_SMS_ALIYUN_ACCESS_KEY_SECRET_KEY);
        ...
        /* endpoint */
        String endpoint = devConfigApi.getValueByKey(NIKA_SMS_ALIYUN_END_POINT_KEY);
    ...
    public static String sendSms(String phoneNumbers, String signName, String templateCode, String templateParam) {
        try {
            ...
            if(ObjectUtil.isEmpty(signName)) {
                // 签名为空，则获取默认签名
                DevConfigApi devConfigApi = SpringUtil.getBean(DevConfigApi.class);
                signName = devConfigApi.getValueByKey(NIKA_SMS_ALIYUN_DEFAULT_SIGN_NAME_KEY);
                if(ObjectUtil.isEmpty(signName)) {
