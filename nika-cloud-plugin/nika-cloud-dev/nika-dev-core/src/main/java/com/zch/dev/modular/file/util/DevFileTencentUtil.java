...
public class DevFileTencentUtil {
    ...
    private static final String NIKA_FILE_TENCENT_SECRET_ID_KEY = "NIKA_FILE_TENCENT_SECRET_ID";
    private static final String NIKA_FILE_TENCENT_SECRET_KEY_KEY = "NIKA_FILE_TENCENT_SECRET_KEY";
    private static final String NIKA_FILE_TENCENT_REGION_ID_KEY = "NIKA_FILE_TENCENT_REGION_ID";
    private static final String NIKA_FILE_TENCENT_DEFAULT_BUCKET_NAME = "NIKA_FILE_TENCENT_DEFAULT_BUCKET_NAME";
    ...
    private static void initClient() {
        ...
        /* secretId */
        String secretId = devConfigApi.getValueByKey(NIKA_FILE_TENCENT_SECRET_ID_KEY);
        ...
        /* secretKey */
        String secretKey = devConfigApi.getValueByKey(NIKA_FILE_TENCENT_SECRET_KEY_KEY);
        ...
        /* regionId */
        String regionId = devConfigApi.getValueByKey(NIKA_FILE_TENCENT_REGION_ID_KEY);
        ...
        /* 默认BucketName */
        defaultBucketName = devConfigApi.getValueByKey(NIKA_FILE_TENCENT_DEFAULT_BUCKET_NAME);
