package com.zch.dev.modular.file.controller;
...
public class DevFileController {
    ...
    /** 默认文件引擎 */
    private static final String NIKA_SYS_DEFAULT_FILE_ENGINE_KEY = "NIKA_SYS_DEFAULT_FILE_ENGINE";
    ...
    public CommonResult<String> uploadDynamicReturnId(@RequestPart("file") MultipartFile file) {
        return CommonResult.data(devFileService.uploadReturnId(devConfigApi.getValueByKey(NIKA_SYS_DEFAULT_FILE_ENGINE_KEY), file));
    }
    ...
    public CommonResult<String> uploadDynamicReturnUrl(@RequestPart("file") MultipartFile file) {
        return CommonResult.data(devFileService.uploadReturnUrl(devConfigApi.getValueByKey(NIKA_SYS_DEFAULT_FILE_ENGINE_KEY), file));
    }
