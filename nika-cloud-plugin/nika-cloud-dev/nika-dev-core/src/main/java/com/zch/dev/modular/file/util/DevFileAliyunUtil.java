...
public class DevFileAliyunUtil {
    ...
    private static final String NIKA_FILE_ALIYUN_ACCESS_KEY_ID_KEY = "NIKA_FILE_ALIYUN_ACCESS_KEY_ID";
    private static final String NIKA_FILE_ALIYUN_ACCESS_KEY_SECRET_KEY = "NIKA_FILE_ALIYUN_ACCESS_KEY_SECRET";
    private static final String NIKA_FILE_ALIYUN_END_POINT_KEY = "NIKA_FILE_ALIYUN_END_POINT";
    private static final String NIKA_FILE_ALIYUN_DEFAULT_BUCKET_NAME = "NIKA_FILE_ALIYUN_DEFAULT_BUCKET_NAME";
    ...
    private static void initClient() {
        ...
        /* accessKeyId */
        String accessKeyId = devConfigApi.getValueByKey(NIKA_FILE_ALIYUN_ACCESS_KEY_ID_KEY);
        ...
        /* accessKeySecret */
        String accessKeySecret = devConfigApi.getValueByKey(NIKA_FILE_ALIYUN_ACCESS_KEY_SECRET_KEY);
        ...
        /* endpoint */
        String endpoint = devConfigApi.getValueByKey(NIKA_FILE_ALIYUN_END_POINT_KEY);
        ...
        /* 默认BucketName */
        defaultBucketName = devConfigApi.getValueByKey(NIKA_FILE_ALIYUN_DEFAULT_BUCKET_NAME);
