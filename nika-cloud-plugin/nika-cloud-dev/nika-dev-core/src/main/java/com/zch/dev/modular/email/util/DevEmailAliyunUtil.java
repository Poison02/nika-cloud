...
public class DevEmailAliyunUtil {
    ...
    private static final String NIKA_EMAIL_ALIYUN_ACCESS_KEY_ID_KEY = "NIKA_EMAIL_ALIYUN_ACCESS_KEY_ID";
    private static final String NIKA_EMAIL_ALIYUN_ACCESS_KEY_SECRET_KEY = "NIKA_EMAIL_ALIYUN_ACCESS_KEY_SECRET";
    private static final String NIKA_EMAIL_ALIYUN_REGION_ID_KEY = "NIKA_EMAIL_ALIYUN_REGION_ID";
    ...
    private static void initClient() {
        ...
        /* accessKeyId */
        String accessKeyId = devConfigApi.getValueByKey(NIKA_EMAIL_ALIYUN_ACCESS_KEY_ID_KEY);
        ...
        /* accessKeySecret */
        String accessKeySecret = devConfigApi.getValueByKey(NIKA_EMAIL_ALIYUN_ACCESS_KEY_SECRET_KEY);
        ...
        /* regionId */
        String regionId = devConfigApi.getValueByKey(NIKA_EMAIL_ALIYUN_REGION_ID_KEY);
