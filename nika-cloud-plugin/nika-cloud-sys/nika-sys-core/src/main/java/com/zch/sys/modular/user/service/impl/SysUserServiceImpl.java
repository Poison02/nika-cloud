package com.zch.sys.modular.user.service.impl;
...
import com.zch.auth.core.pojo.SysLoginUser;
...
import com.zch.common.excel.CommonExcelCustomMergeStrategy;
...
import com.zch.dev.api.DevEmailApi;
import com.zch.dev.api.DevMessageApi;
import com.zch.dev.api.DevSmsApi;
// 0import com.zch.mobile.vip.MobileButtonApi;
// import com.zch.mobile.vip.MobileMenuApi;
...
import com.zch.sys.modular.resource.enums.SysResourceMenuTypeEnum;
...
import com.zch.sys.modular.role.enums.SysRoleDataScopeCategoryEnum;
import com.zch.sys.modular.role.service.SysRoleService;
import com.zch.sys.modular.user.entity.SysUser;
import com.zch.sys.modular.user.mapper.SysUserMapper;
import com.zch.sys.modular.user.param.*;
import com.zch.sys.modular.user.result.*;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    private static final String NIKA_SYS_DEFAULT_PASSWORD_KEY = "NIKA_SYS_DEFAULT_PASSWORD";

    private static final String NIKA_SYS_DEFAULT_WORKBENCH_DATA_KEY = "NIKA_SYS_DEFAULT_WORKBENCH_DATA";
    ...
    public void add(SysUserAddParam sysUserAddParam) {
        ...
        // 设置默认密码
        sysUser.setPassword(CommonCryptogramUtil.doHashValue(devConfigApi.getValueByKey(NIKA_SYS_DEFAULT_PASSWORD_KEY)));
        // 设置状态
    ...
    public void resetPassword(SysUserIdParam sysUserIdParam) {
        this.update(new LambdaUpdateWrapper<SysUser>().eq(SysUser::getId,
                ...
                CommonCryptogramUtil.doHashValue(devConfigApi.getValueByKey(NIKA_SYS_DEFAULT_PASSWORD_KEY))));
    }
    ...
    public String loginWorkbench(SysUserIdParam sysUserIdParam) {
        ...
        return devConfigApi.getValueByKey(NIKA_SYS_DEFAULT_WORKBENCH_DATA_KEY);
    }
    ...
    public void downloadImportUserTemplate(HttpServletResponse response) throws IOException {
        try {
            ...
            CommonDownloadUtil.download("NIKA2.0系统B端用户导入模板.xlsx", bytes, response);
        } catch (Exception e) {
    ...
    public void exportUser(SysUserExportParam sysUserExportParam, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            String fileName = "NIKA2.0系统B端用户信息清单.xlsx";
    ...
    public void exportUserInfo(SysUserIdParam sysUserIdParam, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            // 生成临时导出文件
            resultFile = FileUtil.file(FileUtil.getTmpDir() + File.separator + "NIKA2.0系统B端用户信息_" + sysUser.getName() + ".docx");
            // 写入
