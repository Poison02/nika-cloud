...
import com.zch.common.annotation.CommonNoRepeat;
import com.zch.common.annotation.CommonWrapper;
import com.zch.common.cache.CommonCacheOperator;
import com.zch.common.consts.FeignConstant;
import com.zch.common.enums.CommonDeleteFlagEnum;
...
import com.zch.common.util.CommonTimeFormatUtil;
import com.zch.web.core.handler.GlobalExceptionUtil;
...
public class GlobalConfigure implements WebMvcConfigurer {
     ...
     * 白名单
     */
    private static final String[] NO_LOGIN_PATH_ADDR = {
            /* 主入口 */
            "/",
    ...
    public SaServletFilter getSaServletFilter() {
        return new SaServletFilter()
                ...
                .setAuth(r -> {
                    ...
                    SaRouter.match("/**")
                            // 排除无需登录接口
                            .notMatch(CollectionUtil.newArrayList(NO_LOGIN_PATH_ADDR))
                            // 排除C端认证接口
    ...
    public static class CommonWrapperAop {
         ...
         * 切入点
         */
        @Pointcut("@annotation(com.zch.common.annotation.CommonWrapper)")
    ...
    public Docket appApiDoc() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
                        ...
                        .contact(new Contact("Zch","https://github.com/poison02", "-"))
                        .version("1.0")
                        .build())
